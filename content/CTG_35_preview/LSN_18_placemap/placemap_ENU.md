...
Google Map geolocation from an address can be configured from the **Interface/Places maps** menu.  
The business object on which you want to generate a location map must have a **Geographic Data** type field in order to store the longitude and lattitude of an address.  
