...
Generated MPD example of the module Demo:

![](mpd.svg)

Generated indexes are enough to optimize the SQL queries generated by the engine (searches and joins).
...
It keeps in mind the top 10 long-queries:
