...
This lesson will cover both approaches. The section on **1)** will thus provide an in-depth, hands-on guide, while the section **2)** will be more concise, as the topic is thoroughly covered in the [UI Component](https://docs.simplicite.io/lesson/docs/front/ui-component) lesson.
