...
2. Update the technical platform components (JVM, application server, RDBMS, ...) to their appropriate **up-to-date** versions (please refer to [this document](/lesson/docs/compatibility) for details on approriate components versions for your Simplicité version
