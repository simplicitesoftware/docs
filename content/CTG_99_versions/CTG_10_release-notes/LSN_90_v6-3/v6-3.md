...
### Improved OpenAPI/Swagger schemas <span id="openapischemasimprovements"></span>
...
### Improved mapped API external object configuration <span id="mappedapiextobjectsimprovements"></span>
...
### Added restrictions in development mode only <span id="devmoderestrictions"></span>
