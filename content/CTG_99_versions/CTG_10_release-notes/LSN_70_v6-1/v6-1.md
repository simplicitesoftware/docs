...
> **Warning**: This release note corresponds to a development **BETA** stage platform, it will be regularly amended
...
- Added `AuditTool.checkDeadLinks` to detect dead links in logs and generate a SQL patch
