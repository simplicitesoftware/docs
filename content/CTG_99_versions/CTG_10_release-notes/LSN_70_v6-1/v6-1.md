...
- Bootstrap V4 rendering is deprecated and will be removed in Simplicité 6.2 (the UI runs with bootstrap5 engine since Simplicité V5)
...
### 6.1.0 release candidate 5 (UNRELEASED) <span id="version-6.1.0-beta-rc5"></span>
