...
### 6.1.6 (UNRELEASED) <span id="version-6.1.6"></span>
...
- Backported automatic convertion to PDF for a text publication template file (e.g. HTML, plain text, ...)
...
- Backported the `customPingResponse` platfom hook to customise the `/ping` JSON response if needed
