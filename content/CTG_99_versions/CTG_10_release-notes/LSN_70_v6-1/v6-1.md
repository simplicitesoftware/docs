...
### 6.1.7 (UNRELEASED) <span id="version-6.1.7"></span>

- Supports action groups for Transition buttons
- Fixed download icon on preview page of multi-docs field
- Backported fixes and improvements on audio/video document MIME types
- Accessibility improvements of multi-document field
- Disabled preview & download on non saved multiple documents
- Backported improvements on documents' preview popup
