...
### 6.1.14 (UNRELEASED) <span id="version-6.1.14"></span>
...
- Default MIME type for template/method publications is set to plain text (this fixes issues with PDF conversion using forced MIME type)
