...
- Fixed meta-object delete cascad in case of inheritance (dead links on View Translation)

### 6.1.5 (UNRELEASED) <span id="version-6.1.5"></span>

- Fixed FK completion overflow in the confirm dialog of action
