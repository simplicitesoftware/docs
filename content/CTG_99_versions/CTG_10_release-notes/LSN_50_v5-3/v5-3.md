...
- Backported PostgreSQL using a simple wildcard index search in case of plain text
...
- Backported improvements on resources' file type recognition in the code editor

### 5.3.56 (UNRELEASED) - maintenance revision <span id="version-5.3.56"></span>
