...
### 5.3.39 (2025-05-31) - maintenance revision <span id="version-5.3.39"></span>
...
### 5.3.40 (UNRELEASED) - maintenance revision <span id="version-5.3.40"></span>

- Backported `AuditTool.checkDeadLinks` to detect dead links in logs as SQL patch
- Backported fix force the ENUM loadList before initAction
