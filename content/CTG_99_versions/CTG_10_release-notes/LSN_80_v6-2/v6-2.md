...
### 6.2.1 (UNRELEASED) <span id="version-6.2.1"></span>

- Fix contextual values on panel before calling `initRefSelect` hook
- Fix `AppLog` in DB with related asynchronous task
