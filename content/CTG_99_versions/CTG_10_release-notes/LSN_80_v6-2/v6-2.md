...
- Backported [improvements on OpenAPI/Swagger schemas of generic APIs](../v6-3/#openapischemasimprovements)
- Backported [improvements on mapped API external objects configuration](../v6-3/#mappedapiextobjectsimprovements)
- Backported [restrictions in development mode](../v6-3/#devmoderestrictions)
