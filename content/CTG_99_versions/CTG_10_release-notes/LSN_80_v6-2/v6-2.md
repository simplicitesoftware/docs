...
- New action to generate a reference object from existing object fields
	- designer selects some fields from the object-fields panel
	- and sets the reference object name and table
	...
	- the SQL script can be applied in several instances (dev, test, prod...)
		...
		- update the new foreign keys to the new table

1) Select fields and click on "Generate object"

![](genobj.png)

2) Set the object and table names and confirm
...
4) Apply to get the object with migrated data
