...
> **Note**: This minor version is now in its **short term maintenance** period.
...
### 6.0.16 (2024-07-15) <span id="version-6.0.16"></span>
...
### 6.0.17 (2024-07-25) <span id="version-6.0.17"></span>
...
### 6.0.18 (2024-08-18) <span id="version-6.0.18"></span>
...
### 6.0.19 (UNRELEASED) <span id="version-6.0.19"></span>

- Backported fix missing CSS `.btn-xs` for extra small button since Bootstrap 4
- Backported fix delete cascade in case of `SimpleUser` inheritance (dead links on Responsibilities)
- Backported fix meta-object delete cascad in case of inheritance (dead links on View Translation)
