...
- Backported fix on meta-object delete cascad in case of inheritance (dead links on View Translation)

### 6.0.20 (UNRELEASED) - maintenance revision <span id="version-6.0.20"></span>

- Backported fix FK completion overflow in the confirm dialog of action
- Allows grouped actions on list