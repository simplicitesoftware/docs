...
### 6.0.23 (UNRELEASED) - maintenance revision <span id="version-6.0.23"></span>

- Backported fix completion dropdown in case of right/left side modal
- Backported fix UI target object in some case of update
