...
### 6.0.25 (UNRELEASED) - maintenance revision <span id="version-6.0.24"></span>
...
- Backported fix on missing support for JSON format in the "apply" action of the `Dataset` object
