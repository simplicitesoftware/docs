...
### 6.0.17 (UNRELEASED) <span id="version-6.0.17"></span>
...
- Backported `JSONAdapter` & `YAMLAdapter` refactoring to support Array of objects and same business logic except format conversion
