...
1. Click **Edit form** on the Business object's form (this will open the **template editor**)  
	...
	> The template editor is also available via the Modeler, for more information see the [Accessing the template editor via the Modeler](/lesson/docs/platform/business-objects/business-objects#creation-assistant-via-the-modeler)
